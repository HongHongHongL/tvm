...
"""A element-wise schedule rule for CPU operators."""
...
class ElementWise(CPUScheduleRule):
    """The schedule rule for element-wise computation"""
    ...
    def apply(  # pylint: disable=too-many-locals,missing-docstring
        ...
        for block in block_infos:
            ...
            # tx, _, vx = sch.split(  # pylint: disable=invalid-name
            #     sch.fuse(*s_loops),
            #     factors=[core_num, None, vector_size],
            # )
